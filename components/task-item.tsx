...
import { CheckCircle2, MoreVertical, Edit3, Trash2, Calendar, AlertTriangle } from "lucide-react"
...
export function TaskItem({ task, onUpdate, onDelete, index }: TaskItemProps) {
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between mb-2">
                <div className="flex-1">
                  <h3
                    className={`font-medium text-balance ${task.completed ? "line-through text-muted-foreground" : ""}`}
                  >
                    {task.title}
                  </h3>
                  {task.description && (
